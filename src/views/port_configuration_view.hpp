...
namespace views
{
	...
	public:
		...
		virtual [[nodiscard]] std::optional<size_t>& selectedAvailablePort() noexcept = 0;
		virtual [[nodiscard]] bool portOpenEnabled() const noexcept = 0;
		virtual [[nodiscard]] std::string portOpenButtonText() const = 0;
		virtual void onPortOpenButtonClicked() = 0;
		virtual [[nodiscard]] std::string portCloseButtonText() const = 0;
		virtual void onPortCloseButtonClicked() = 0;
		virtual [[nodiscard]] std::span<const std::string> openedPorts() const noexcept = 0;
		virtual [[nodiscard]] std::optional<size_t>& selectedOpenedPort() noexcept = 0;
		virtual [[nodiscard]] bool portControlsEnabled() const noexcept = 0;
